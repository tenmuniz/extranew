        ...
        <div className="flex flex-col w-full">
          ...
          {onRemove && (
            <div className="flex justify-end mt-0.5">
              <button 
                className="flex-shrink-0 w-8 h-8 rounded-full bg-white/80 flex items-center justify-center text-red-500 hover:bg-red-100 hover:text-red-700 transition-colors duration-150 shadow-sm remove-button touch-manipulation prevent-select"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
